...
<aside class="w-64 h-screen bg-red-600 text-white p-4">
    <h2 class="text-xl font-semibold mb-4">Menu</h2>
    <ul class="space-y-2">
        <x-sidebar-item route="admin.dashboard"><i class="fa-solid fa-house w-8"></i>Dashboard</x-sidebar-item>
        <x-sidebar-item route="products.index"><i class="fa-solid fa-briefcase w-8"></i>Products</x-sidebar-item>
        ...
        <x-sidebar-item route="admin.users"><i class="fa-solid fa-user w-8"></i>Users</x-sidebar-item>
    </ul>
</aside>
